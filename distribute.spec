...
coll = COLLECT(exe,
               ...
               Datafiles('data/images/barb/*.png', strip_path=False),
               Datafiles('data/images/girl/*.png', strip_path=False),
               Datafiles('data/images/derp/*.png', strip_path=False),
               Datafiles('data/images/bosses/warlord/*.png', strip_path=False),
               Datafiles('data/images/bosses/chieftain/*.png', strip_path=False),
               Datafiles('data/images/projectiles/*.png', strip_path=False),
               Datafiles('data/images/tilesets/*.png', strip_path=False),
               Datafiles('data/images/ui/*.png', strip_path=False),
